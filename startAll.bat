...
java -classpath %targetDirectory%;src/test/resources/libs/junit-4.13.2.jar;src/test/resources/libs/hamcrest-core-1.3.jar  org.junit.runner.JUnitCore wordleTest.ParametrizedGameTest
