...
INSERT INTO "user"  (email, password, phone, name, nickname, role, statistic_id, registered_date) VALUES ('admin@gmail.com', '$2a$12$sMoMVIRnKvFHHcT4KMS/FeTSn0P1NzgPm8wI7wuHpmzxRdGf9fjc6', '88005553535', 'admin', 'admin', 'ROLE_admin',1, '2022-08-07') ON CONFLICT DO NOTHING;
